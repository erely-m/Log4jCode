...
public class LoggingEvent implements java.io.Serializable {
  ...
  transient public final String fqnOfCategoryClass; //Logger的全限定名称
   ...
   * */
  transient private Category logger; //Logger对象
   ...
   * */
  final public String categoryName; //Logger对象名
   ...
   * */
  transient public Priority level; //日志级别
  ...
  transient private Object message; //消息内容

  /** The application supplied message rendered through the log4j
      objet rendering mechanism.*/
  private String renderedMessage;//经过ObjectRender处理后的日志信息，提供给Layout使用。
