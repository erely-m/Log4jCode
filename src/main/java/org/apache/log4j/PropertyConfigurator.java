...
public class PropertyConfigurator implements Configurator {
   ...
   */
  protected Hashtable registry = new Hashtable(11);   //存储appender的注册器暂存
  private LoggerRepository repository; //Logger容器
  protected LoggerFactory loggerFactory = new DefaultCategoryFactory(); //构建容器
  ...
  static final String      APPENDER_PREFIX = "log4j.appender."; //appender前缀
...
new PropertyConfigurator().doConfigure(inputStream,
  ...
  */
  ...
  void parseCategory(Properties props, Logger logger, String optionKey,
    ...
    StringTokenizer st = new StringTokenizer(value, ","); //,分隔值
  ...
  void parseAppenderFilters(Properties props, String appenderName, Appender appender) {
    ...
    final String filterPrefix = APPENDER_PREFIX + appenderName + ".filter."; //拦截器
