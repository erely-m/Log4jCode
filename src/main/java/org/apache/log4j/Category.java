...
public class Category implements AppenderAttachable {
  ...
  */
  ...
  protected ResourceBundle resourceBundle; //国际化

  // Categories need to know what Hierarchy they are in
  protected LoggerRepository repository; //所在仓库


  AppenderAttachableImpl aai; //Logger关联Appender集合类
  ...
  protected boolean additive = true; //是否继承父节点的Appender
  ...
  */
  ...
  void forcedLog(String fqcn, Priority level, Object message, Throwable t) {
    callAppenders(new LoggingEvent(fqcn, this, level, message, t)); //创建日志时间并appender
  }
