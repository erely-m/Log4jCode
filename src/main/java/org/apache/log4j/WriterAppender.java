...
/**
   ...
   @since 1.1 */
public class WriterAppender extends AppenderSkeleton { //写入IO中的Appender
  ...
  */
  protected boolean immediateFlush = true; //写完一条日志立刻刷心标志
  ...
  */
  ...
  protected
  OutputStreamWriter createWriter(OutputStream os) { //创建Writer
